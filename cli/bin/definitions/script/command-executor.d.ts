...
export declare var confirm: (message?: string) => Q.Promise<boolean>;
...
export declare var runReactNativeBundleCommand: (bundleName: string, development: boolean, entryFile: string, outputFolder: string, platform: string, sourcemapOutput: string, config: string) => Q.Promise<void>;
